...
* **type**: Specifies the type of block to allocate. See link:../../enums/utils/dlu_block_type.html[dlu_block_type(3)] for more details.
* **addr**: Addresses passed here should be the starting address of the link:../../structs/vkcomp/vkcomp.html[vkcomp(3)] or link:../../structs/drm/dlu_drm_core.html[dlu_drm_core(3)] structures.
