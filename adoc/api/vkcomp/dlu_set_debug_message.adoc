...
When using this function, first query for available layers and instance extensions with link:../../cmd/lucur.html[lucur(1)] command line helper tool. After enable available validation layers
