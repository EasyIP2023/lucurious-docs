...
* **DLU_SMALL_BLOCK_PRIV**: Enum value for specifying a small private block of memory. This value is be passed when link:../../api/utils/dlu_otba.html[dlu_otba(3)]
...
* **DLU_SMALL_BLOCK_SHARED**: Enum value for specifying a small shared block of memory. This value is be passed when link:../../api/utils/dlu_otba.html[dlu_otba(3)]
